...
#################################################################################
data=pd.read_csv("C:\\Users\\Christopher\\Desktop\\Mathematical Medicine\\heart.csv")
X=data.iloc[:,0:13]
Y=data.iloc[:,-1]
#####################################################################################
...
classifier.add(Dense(output_dim=60, init='random_uniform', activation='relu', input_dim=13))
classifier.add(Dense(output_dim=60, init='random_uniform', activation='relu'))
classifier.add(Dense(output_dim=60, init='random_uniform', activation='relu'))
